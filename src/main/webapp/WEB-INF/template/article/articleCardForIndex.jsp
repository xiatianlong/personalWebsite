...
<div class="layui-col-xs12 layui-col-sm12 layui-col-md12 xtl-block xtl-article-card" data-type="${article.type}"
     data-article-id="${article.id}">
    <c:choose>
        <c:when test="${not empty article.imgUrl}">
            ...
            <div class="layui-col-xs12 layui-col-sm8 layui-col-md8 article-card-right-content">
                ...
                <div class="article-summary">${article.introduction}</div>
            </div>
        </c:when>
        <c:otherwise>
    ...
    <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 article-card-footer padding-t-15">
        ...
        <div class="layui-col-xs6 layui-col-sm3 layui-col-md3 layui-hide-xs gray text-r">
            <span><i class="fa fa-eye" aria-hidden="true"></i> ${article.viewsCnt}</span>
            <%--<span class="padding-l-10"><i class="fa fa-commenting-o" aria-hidden="true"></i> 100</span>--%>
        </div>
    </div>
    <input type="hidden" name="loadMoreId" value="${article.orderKey}">
</div>